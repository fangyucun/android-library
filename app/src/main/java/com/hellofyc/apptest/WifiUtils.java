 ...
 * {@link Manifest.permission#CHANGE_NETWORK_STATE}
...
public class WifiUtils {
	...
	/**
	 * Use Permission
	 * {@link Manifest.permission#WAKE_LOCK}
	 */
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (WifiManager.NETWORK_STATE_CHANGED_ACTION.equals(action)) {
				...
				if (networkInfo != null && networkInfo.isConnected()) {
					...
					WifiInfo wifiInfo = getConnectionInfo();
					String ssid = WifiUtils.removeDoubleQuotesIfExists(wifiInfo.getSSID());
					if (isSsidValid(ssid)) {
						if (ssid.equals(WifiUtils.removeDoubleQuotesIfExists(mConnectSSID))) {
