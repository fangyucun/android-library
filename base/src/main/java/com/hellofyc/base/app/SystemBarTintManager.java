...
public class SystemBarTintManager {
    ...
    public static SystemBarTintManager newInstance(Activity a) {
    	return new SystemBarTintManager(a);
    }
	...
	public void setTranslucentStatus(Activity a, boolean trueOrFalse) {
		if (Build.VERSION.SDK_INT >= 19) {
			setAttributesTrueOrFalse(a, WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS, trueOrFalse);
		}
	}
