 ...
 * @author Jason Fang
 */
abstract public class BaseRecyclerViewAdapter<T> extends Adapter<BaseRecyclerViewAdapter.AbsItemViewHolder>
    ...
    public static abstract class AbsItemViewHolder extends ViewHolder {
