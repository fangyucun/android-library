...
public final class ImageUtils {
    ...
    public static Bitmap createBitmap(int width, int height, @NonNull Bitmap.Config config, int retryCount) {
        try {
    ...
    public static Bitmap createBitmapFromView(@NonNull View view) {
        ...
        view.clearFocus();
        Bitmap bitmap = createBitmap(view.getWidth(), view.getHeight(), Bitmap.Config.ARGB_8888, 1);
        if (bitmap != null) {
	...
	public static void setImageInFade(ImageView image, @DrawableRes int id) {
		if (image == null || id == 0) return;
		
		setImageInFade(image, ContextCompat.getDrawable(image.getContext(), id));
	}
